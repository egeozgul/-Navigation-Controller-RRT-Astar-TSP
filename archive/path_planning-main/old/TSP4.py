...
def gotoCorner2(visited, myblue_line):
    ...
    if not enters_any:
        ...
        return valid_lines2  # this vline ends here, we don't need to move forward.
    ...
    for line in valid_lines2:
        valid_lines3.append(gotoCorner2(visited,line))
...
for vline in processedLine:
    visited = [vline["p2"]]
    valid_lines2.append(gotoCorner2(visited, vline))
